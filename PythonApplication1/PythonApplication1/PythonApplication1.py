...
"""
def define_flags():
  flags.DEFINE_string("model_file", "C:/Users/USER/Downloads/converted_tflite_quantized/model.tflite",
                      "Path and file name to the TFLite model file.")
  flags.DEFINE_string("label_file", "C:/Users/USER/Downloads/converted_tflite_quantized/labels.txt", "Path to the label file.")

  flags.DEFINE_string("export_directory", "model_with_metadata",
...
class MetadataPopulatorForImageClassifier(object):
  ...
  def __init__(self, model_file, model_info, label_file_path):
    self.model_file = "C:/Users/USER/Documents/Downloads/Downloads (1)/final_model.tflite"
    self.model_info = model_info
    self.label_file_path = "C:/Users/USER/Documents/Downloads/Downloads (1)/labels.txt"
...
def main(_):
  model_file = "C:/Users/USER/Documents/Downloads/Downloads (1)/final_model.tflite"
  model_basename = os.path.basename(model_file)
  if model_basename not in _MODEL_INFO:
    raise ValueError(
        "The model info for, {0}, is not defined yet.".format(model_basename))

  export_model_path = os.path.join("C:/Users/USER/Documents/Downloads/", model_basename)
  ...
  populator = MetadataPopulatorForImageClassifier(
      export_model_path, _MODEL_INFO.get(model_basename), "C:/Users/USER/Documents/Downloads/Downloads (1)/labels.txt")
  populator.populate()

  # Validate the output model file by reading the metadata and produce
  # a json file with the metadata under the export path
  displayer = _metadata.MetadataDisplayer.with_model_file(export_model_path)
  export_json_file = os.path.join("C:/Users/USER/Documents/Downloads/",
