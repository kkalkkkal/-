...
public class DetectorTest {
  ...
  private static final String MODEL_FILE = "final_model.tflite";
  ...
  public void detectionResultsShouldNotChange() throws Exception {
    ...
    canvas.drawBitmap(loadImage("milk.jpg"), frameToCropTransform, null);
    final List<Recognition> results = detector.recognizeImage(croppedBitmap);
    final List<Recognition> expected = loadRecognitions("milk_result.txt");
