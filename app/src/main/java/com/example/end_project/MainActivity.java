...
//sst
    ...
    public void TTS() throws FileNotFoundException {    //tts speakout 함수 : 입력된 텍스트를 음성으로 출력하는 함수
        //파일 객체 생성
        Object input;
        File file = new File("raw/inform.txt");
        //입력 스트림 생성
        InputStream is = getResources().openRawResource(R.raw.inform);
    //FileReader filereader = new FileReader(file);  // 파일을 못 읽어오네...
        ...
        while(scan.hasNextLine()){
            tts.speak(scan.nextLine(), TextToSpeech.QUEUE_FLUSH, null, "id1");
            //onDestroy();
        ...
        //tts.speak("안녕하세요", TextToSpeech.QUEUE_FLUSH, null, "id1");
